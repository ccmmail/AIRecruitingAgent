export const DEMO_JOB_DESCRIPTION = `Chief Executive Officer - AI Robotics Startup
...
export const DEMO_RESPONSE = {
  Fit: {
    score: 7,
    rationale:
      "Strong executive leadership, P&L, product-to-scale experience, AI/ML program delivery, and history of building organizations at growth-stage and private-equity-backed companies — all highly relevant to a CEO of an early-stage AI company. Gaps: limited explicit robotics/SLAM/perception or embedded-systems domain experience, no documented lead role in venture fundraising or IPO preparation, and limited explicit evidence of hiring large engineering teams for core autonomy stacks. Seniority, cross-functional management, and scaling experience align well with the role.",
  },
  Gap_Map: [
    {
      "JD Requirement/Keyword": "CEO / progressive leadership 10+ years, startup or growth-stage leadership",
      "Present in Resume?": "Y",
      "Where/Evidence":
        "Multiple senior roles: CPO & GM at Move Inc (led 140-person org); EVP at Financial Engines; Operating Executive at Silver Lake; CPO roles at startups (33Across, JAXTR).",
      "Gap handling": "rephrase",
    },
    {
      "JD Requirement/Keyword": "Background in technology, AI, robotics, or autonomous systems",
      "Present in Resume?": "Partial",
      "Where/Evidence":
        "AI/ML personalization and ML/Data Science organization at Move Inc and Financial Engines; instituted AI workflows at Silver Lake; adtech/data platforms at 33Across and YP.",
      "Gap handling": "add/rephrase",
    },
    {
      "JD Requirement/Keyword":
        "Experience building/scaling engineering teams (Navigation, SLAM, perception, embedded)",
      "Present in Resume?": "Partial",
      "Where/Evidence":
        "Led product, analytics, and created ML/Data Science organization; led large cross-functional teams; recruited C-levels at Silver Lake.",
      "Gap handling": "add/rephrase",
    },
    {
      "JD Requirement/Keyword": "Capital raising, investor relations, exit/IPO planning",
      "Present in Resume?": "N",
      "Where/Evidence": "No explicit bullets describing fundraising, capital raises, or IPO prep.",
      "Gap handling": "omit/add question",
    },
    {
      "JD Requirement/Keyword": "Hands-on collaboration with engineering and technical leadership",
      "Present in Resume?": "Y",
      "Where/Evidence":
        "Partnered with CPOs and CTOs at Silver Lake; drove AI/ML personalization with product and engineering at Move Inc; built ML/Data Science org at Financial Engines.",
      "Gap handling": "rephrase",
    },
    {
      "JD Requirement/Keyword": "Building company culture focused on innovation, accountability, speed",
      "Present in Resume?": "Y",
      "Where/Evidence":
        "Drove culture transformations, employee engagement increases, organization rebuilds at Move Inc and Financial Engines.",
      "Gap handling": "rephrase",
    },
    {
      "JD Requirement/Keyword": "Technical domain: robotics / autonomous navigation",
      "Present in Resume?": "N",
      "Where/Evidence": "No mention of robotics, SLAM, perception, or embedded systems in resume.",
      "Gap handling": "omit/add question",
    },
    {
      "JD Requirement/Keyword": "Education: technical (Engineering/CS) or MBA",
      "Present in Resume?": "Y",
      "Where/Evidence": "MBA, MIT Sloan; Bachelor of Science (Statistics), Bachelor of Commerce (Economics).",
      "Gap handling": "omit",
    },
  ],
  Questions: [
    "Have you ever served as CEO or interim-CEO (yes/no)? If yes, list company and dates.",
    "Have you led or directly participated in any fundraising rounds (seed/Series A+/IPO)? If yes, list round types and amounts or your role (short answer).",
    "Do you have hands-on experience with robotics, SLAM, perception or embedded systems (yes/no)? If yes, describe briefly.",
    "How many engineers (headcount) have you hired or directly managed in a single organization? Provide approximate number and seniority (short answer).",
    "Describe one example of investor or board-facing representation you led (company, context, outcomes) — brief.",
  ],
  Tailored_Resume:
