  ...
  Gap_Map: [
    {
      ...
      "Where/Evidence":
        "Silver Lake portfolio work and Move Inc AI/ML personalization projects; no explicit robotics or navigation systems experience.",
      "Gap handling":
        "Add any relevant exposure to robotics, sensors, or navigation from portfolio work; emphasize AI aspects.",
    },
    {
      "JD Requirement/Keyword": "Early-stage / startup leadership",
      "Present in Resume?": "Partial",
      "Where/Evidence":
        "33Across (Series B), Jaxtr (Series A), Upwork (Series A) leadership roles; not framed as full CEO/founder build-outs.",
      "Gap handling": "Rephrase bullets to emphasize company build-out, team formation, and zero-to-one execution.",
    },
    {
      "JD Requirement/Keyword": "Fundraising / investor relations",
      "Present in Resume?": "N",
      "Where/Evidence": "Not mentioned in resume.",
      "Gap handling": "Add any involvement in fundraising, board presentations, investor pitches; if none, omit.",
    },
    {
      "JD Requirement/Keyword": "Team-building from scratch",
      "Present in Resume?": "Y",
      "Where/Evidence": "Move Inc: rebuilt product org; Silver Lake: recruited 10+ C-level execs.",
      "Gap handling": "Rephrase to explicitly match JD language ('built high-performing teams from inception').",
    },
    {
      "JD Requirement/Keyword": "Technical product direction with engineering",
      "Present in Resume?": "Y",
      "Where/Evidence": "Multiple CPO/EVP roles collaborating with CTOs and leading product/engineering.",
      "Gap handling": "Use language like 'guided technical product roadmap with engineering leadership'.",
    },
    {
      "JD Requirement/Keyword": "Capital markets / IPO preparation",
      "Present in Resume?": "N",
      "Where/Evidence": "No IPO-specific or pre-IPO readiness mentioned.",
      "Gap handling": "If applicable from Silver Lake or other roles, add; otherwise omit.",
    },
  ],
  Questions: [
    ...
    "In any of your startup roles (e.g., Jaxtr, Upwork, 33Across), did you build the founding team or hire the first engineers from scratch?",
    "Were you involved in any IPO readiness or public market preparation in your Silver Lake portfolio companies?",
    "What was the largest budget or capital program you directly managed in an early-stage context?",
  ],
  Tailored_Resume:
